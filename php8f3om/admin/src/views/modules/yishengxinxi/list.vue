  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="医生工号" prop="yishenggonghao">
		  <el-select  @change="yishenggonghaoChange" clearable v-model="searchForm.yishenggonghao" placeholder="请选择医生工号">
		    <el-option
		...
		<el-form-item class="select" label="科室分类" prop="keshifenlei">
		  <el-select  @change="keshifenleiChange" clearable v-model="searchForm.keshifenlei" placeholder="请选择科室分类">
		    <el-option
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yishengxinxi','立即预约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="yuyueguahaoCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'立即预约':'' }}</el-button>
                <el-button v-if="isAuth('yishengxinxi','立即预约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="yuyueguahaoCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'立即预约':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yishengxinxi','立即预约') && contents.tableBtnIcon == 0" type="success" size="mini" @click="yuyueguahaoCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'立即预约':'' }}</el-button>
